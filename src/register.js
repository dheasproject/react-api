                                        ...
                                        <div class="settings_panel card no_margin">
                                            ...
                                            <div>
                                                <ul class="panel svg_check no_scroll">
                                                    <li>
                                                        <span class="glyphicons_v2 check"></span> Find something to watch on your subscribed streaming services
                                                    </li>
                                                    <li>
                                                        <span class="glyphicons_v2 check"></span> Log the movies and TV shows you have watched
                                                    </li>
                                                    <li>
                                                        <span class="glyphicons_v2 check"></span> Keep track of your favourite movies and TV shows and get recommendations from them
                                                    </li>
                                                    <li>
                                                        <span class="glyphicons_v2 check"></span> Build and maintain a personal watchlist
                                                    </li>
                                                    <li>
                                                        <span class="glyphicons_v2 check"></span> Build custom mixed lists (movies and TV)
                                                    </li>
                                                    <li>
                                                        <span class="glyphicons_v2 check"></span> Take part in movie and TV discussions
                                                    </li>
                                                    <li>
                                                        <span class="glyphicons_v2 check"></span> Contribute to, and improve the information in our database
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                        ...
                                        <section class="content">
                                            <div class="column_content">
                                                ...
                                                <form id="signup_form" class="k-form" action="/signup" name="account_signup" method="post" accept-charset="utf-8">
                                                    ...
                                                    <div class="flex">
                                                        <a href="/login">
                                                            <input id="sign_up_button" class="k-button k-primary" value="Sign Up" />
                                                        </a>
                                                        <p class="reset">
                                                            <a href="/">Cancel</a>
                                                        </p>
