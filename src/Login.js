        ...
        <form id="login_form" class="k-form" action="/login" name="account_login" method="post" accept-charset="utf-8">
          ...
          <fieldset>
            <label class="k-form-field" for="username">
              <span>Username</span>
              <input id="username" class="k-textbox" type="text" name="username" value="" autocapitalize="off"/>
            </label>

            <label class="k-form-field" for="password">
              <span>Password</span>
              <input id="password" class="k-textbox" type="password" name="password"/>
            </label>
          </fieldset>

          <div class="flex">
          <a href="/home"><input id="sign_up_button" class="k-button k-primary" value="Login"/></a>
            <p class="reset"><a href="/reset-password">Reset password</a></p>
          </div>
        </form>
      </div>
    </div>
